...
const eventData: Record<string, any> = {
  'traditional-coding': {
    ...
    teamSize: "Teams of 2",
    about: "Showcase your coding skills in this traditional programming competition. Solve complex algorithmic problems, optimize your solutions, and compete against the best programmers. This event tests your problem-solving abilities, coding efficiency, and algorithmic thinking.",
    poster: traditionalPoster,
    category: "technical",
    participants: "Teams of 2",
    description: "Showcase your coding skills in this traditional programming competition",
  ...
  'blind-coding': {
    ...
    eventType: "Main Event",
    teamSize: "Solo/Group",
    about: "Code without seeing! Test your muscle memory and coding knowledge. Participants will be blindfolded and must write code based on verbal instructions or memory. This unique challenge tests your programming fundamentals and ability to code under pressure.",
    poster: blindPoster,
    category: "technical",
    participants: "Solo/Group",
    description: "Code without seeing! Test your muscle memory and coding knowledge",
  ...
  'paper-presentation': {
    ...
    eventType: "Main Event",
    teamSize: "Teams of 3",
    about: "Present your innovative ideas and research findings. This event provides a platform for students to showcase their technical papers, research projects, and innovative solutions. Topics can range from emerging technologies to sustainable solutions.",
    poster: paperPoster,
    category: "technical",
    participants: "Teams of 3",
    description: "Present your innovative ideas and research findings",
  ...
  'prompt-engineering': {
    ...
    eventType: "Main Event",
    teamSize: "Solo",
    about: "Master the art of AI prompt engineering. Learn to craft effective prompts for AI models, understand AI behavior, and create innovative AI-powered solutions. This event explores the intersection of human creativity and artificial intelligence.",
    poster: promptPoster,
    category: "technical",
    participants: "Solo",
