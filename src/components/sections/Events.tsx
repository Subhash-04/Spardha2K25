    ...
    day2: [
      {
        ...
        description: "Learn the art of crafting effective prompts for AI systems",
      ...
      },
      {
        ...
        icon: Palette,
        participants: "All",
        description: "Present your research papers on innovative technological solutions",
